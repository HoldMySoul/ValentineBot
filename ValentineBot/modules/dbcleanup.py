...
import ValentineBot.modules.sql.global_bans_sql as gban_sql
import ValentineBot.modules.sql.users_sql as user_sql
from ValentineBot import DEV_USERS, OWNER_ID, dispatcher
