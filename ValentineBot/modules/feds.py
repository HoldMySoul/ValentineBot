...
import ValentineBot.modules.sql.feds_sql as sql
from ValentineBot import (
    EVENT_LOGS,
    LOGGER,
    SUPPORT_CHAT,
    OWNER_ID,
...
from ValentineBot.modules.helper_funcs.admin_status import get_bot_member, user_is_admin
from ValentineBot.modules.helper_funcs.alternate import send_message
from ValentineBot.modules.helper_funcs.chat_status import (
    is_user_admin,
    can_delete,
)
from ValentineBot.modules.helper_funcs.extraction import (
    extract_unt_fedban,
    extract_user,
    extract_user_fban,
)
from ValentineBot.modules.helper_funcs.string_handling import markdown_parser
...
from ValentineBot.modules.sql.users_sql import get_user_com_chats
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        fed_name = info["fname"]
        # https://t.me/ValentineBotSupport/41606 // https://t.me/ValentineBotSupport/41619
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "ValentineBot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="ValentineBot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "ValentineBot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="ValentineBot_fbanned_users.csv",
