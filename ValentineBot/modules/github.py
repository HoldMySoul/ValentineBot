...
import ValentineBot.modules.helper_funcs.git_api as api
import ValentineBot.modules.sql.github_sql as sql

from ValentineBot.modules.sql.clear_cmd_sql import get_clearcmd
from ValentineBot import dispatcher, OWNER_ID, EVENT_LOGS, SUDO_USERS, SUPPORT_USERS
