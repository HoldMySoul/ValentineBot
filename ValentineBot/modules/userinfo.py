...
from ValentineBot.__main__ import STATS, GDPR, TOKEN, USER_INFO
import ValentineBot.modules.sql.userinfo_sql as sql
from ValentineBot.modules.disable import DisableAbleCommandHandler
from ValentineBot.modules.sql.global_bans_sql import is_user_gbanned
from ValentineBot.modules.sql.afk_sql import is_afk, check_afk_status
from ValentineBot.modules.sql.users_sql import get_user_num_chats
from ValentineBot.modules.sql.clear_cmd_sql import get_clearcmd
from ValentineBot.modules.helper_funcs.chat_status import sudo_plus
from ValentineBot.modules.helper_funcs.extraction import extract_user
from ValentineBot.modules.helper_funcs.misc import delete
from ValentineBot import telethn as ValentineBotTelethonClient, SUDO_USERS, SUPPORT_USERS
...
def gdpr(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not ValentineBot data. "
