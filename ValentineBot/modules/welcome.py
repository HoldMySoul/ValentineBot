...
import ValentineBot.modules.sql.welcome_sql as sql
import ValentineBot
...
from ValentineBot.modules.helper_funcs.misc import build_keyboard, delete, revert_buttons
from ValentineBot.modules.helper_funcs.msg_types import get_welcome_type
...
def new_member(update: Update, context: CallbackContext):
    ...
    if new_mem.id == bot.id and not ValentineBot.ALLOW_CHATS:
    ...
    if should_welc:
        ...
        # Welcome yourself
            ...
            dispatcher.bot.send_message(chat.id,
                "Thanks for adding me! Join https://t.me/ValentineBotSupport for support.",
                disable_web_page_preview=True,
            )
