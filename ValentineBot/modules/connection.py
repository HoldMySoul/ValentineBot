...
import ValentineBot.modules.sql.connection_sql as sql
from ValentineBot import dispatcher, SUDO_USERS, DEV_USERS
from ValentineBot.modules.helper_funcs import chat_status
