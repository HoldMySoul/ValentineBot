...
import ValentineBot.modules.sql.notes_sql as sql
from ValentineBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ValentineBot.__main__ import DATA_IMPORT
from ValentineBot.modules.helper_funcs.chat_status import user_admin
from ValentineBot.modules.helper_funcs.alternate import typing_action

# from ValentineBot.modules.rules import get_rules
import ValentineBot.modules.sql.rules_sql as rulessql

# from ValentineBot.modules.sql import warns_sql as warnssql
import ValentineBot.modules.sql.blacklist_sql as blacklistsql
from ValentineBot.modules.sql import disable_sql as disabledsql

# from ValentineBot.modules.sql import cust_filters_sql as filtersql
# import ValentineBot.modules.sql.welcome_sql as welcsql
import ValentineBot.modules.sql.locks_sql as locksql
from ValentineBot.modules.connection import connected
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("ValentineBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ValentineBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ValentineBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ValentineBot{}.backup".format(chat_id))  # Cleaning file
