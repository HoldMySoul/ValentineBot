...
from ValentineBot import telethn as ValentineBotTelethonClient
from ValentineBot.modules.sql.clear_cmd_sql import get_clearcmd
from ValentineBot.modules.helper_funcs.telethn.chatstatus import user_is_admin
from ValentineBot.modules.helper_funcs.misc import delete


@ValentineBotTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
