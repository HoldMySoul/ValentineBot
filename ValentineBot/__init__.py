...
if ENV:
    ...
    from ValentineBot.config import Development as Config
...
telethn = TelegramClient("ValentineBot", API_ID, API_HASH)
...
from ValentineBot.modules.helper_funcs.handlers import (
