...
from ValentineBot.modules import ALL_MODULES
from ValentineBot.modules.helper_funcs.chat_status import is_user_admin
from ValentineBot.modules.helper_funcs.misc import paginate_modules
...
ValentineBot_IMG = "https://i.imgur.com/1oah5E2.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
ValentineBot is hosted on its own server and doesn't require any donations as of now but \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ValentineBot.modules." + module_name)
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                text="Add ValentineBot to your group",
                        ...
                        [
                            InlineKeyboardButton(
                                text="Support Group",
                                url=f"https://t.me/ValentineBotSupport",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                        ...
                        [
                            InlineKeyboardButton(
                                text="Source code",
                                url="https://github.com/Astrako/ValentineBot",
                            )
                        ],
                        [
                            InlineKeyboardButton(
